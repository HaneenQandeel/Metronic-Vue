<template>
	<div class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default" style="margin-top:-60px;">
								...
								<div class="m-login__signin">
									...
									<form class="m-login__form m-form" action="">
										<div class="form-group m-form__group">
											<input class="form-control m-input" type="text" placeholder="Email" name="email" v-model="email" autocomplete="off">
										</div>
										<div class="form-group m-form__group">
								...
								<div class="m-login__forget-password">
									...
									<form class="m-login__form m-form" action="">
										...
										<div class="m-login__form-action">
                                            ...
                                            <button id="m_login_signup" class="m-link m-link--focus m-login__account-link">Sign Up</button>
										</div>
									</form>
								</div>
							</div>
